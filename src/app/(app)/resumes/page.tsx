      ...
      <Card>
        ...
        <CardBody className="pt-0">
            ...
            <div className="relative">
              <input
                ...
                className={cn(
                  ...
                  "border-[var(--border)] focus:border-[var(--border-strong)] focus:ring-4 focus:ring-[rgba(10,36,101,0.10)]"
                )}
              />
            </div>
              ...
              {roles.map((r) => (
                <button
                  ...
                  className={cn(
                    ...
                    role === r
                      ? "bg-[rgba(10,36,101,0.06)] text-[#000000]"
                      : "text-[var(--muted)] hover:text-[#000000]"
                  )}
                >
                  {r}
                </button>
          ...
          <div className="mt-3 overflow-hidden rounded-[14px] border border-[var(--border)] bg-white">
            <div className="grid grid-cols-[120px_140px_1fr_120px_120px_120px_140px] gap-0 border-b border-[var(--border)] bg-[rgba(10,36,101,0.02)] px-3 py-2 text-[11px] font-medium text-[rgba(10,36,101,0.70)]">
              <div>이름</div>
              <div>지원 직무</div>
              <div>학력/전공</div>
              <div>경력(연차)</div>
            ...
            {rows.map((c) => (
              <div
                key={c.id}
                className="grid grid-cols-[120px_140px_1fr_120px_120px_120px_140px] items-center px-3 py-2.5 text-sm border-b border-[rgba(10,36,101,0.06)] hover:bg-[rgba(10,36,101,0.015)] transition"
              >
                <div className="font-medium text-[#000000]">{c.name}</div>
                <div className="text-[12px] text-[rgba(10,36,101,0.75)]">
                  {c.appliedRole}
                </div>
                <div className="text-[12px] text-[rgba(10,36,101,0.72)]">
      ...
      <Card tone="sky">
        ...
        <CardBody className="pt-1">
          <div className="rounded-[14px] border border-[var(--border)] bg-white px-4 py-4">
            ...
            <div className="mt-2 text-[12px] leading-[1.7] text-[rgba(10,36,101,0.72)]">
