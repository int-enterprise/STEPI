    ...
    <Card>
      ...
      <CardBody className="pt-0.5">
        <div className="grid grid-cols-3 gap-2">
          <div className="rounded-xl border border-[var(--border)] bg-[rgba(10,36,101,0.02)] px-2.5 py-2">
        ...
        <div className="mt-3">
          <div className="text-[11px] font-medium text-[#000000]">강점</div>
        ...
        <div className="mt-2.5">
          <div className="text-[11px] font-medium text-[#000000]">약점</div>
          <div className="mt-1 flex flex-wrap gap-1.5">
